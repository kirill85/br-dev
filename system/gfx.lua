...
function GFX.new()
        ...
        self.debugTexturePane = get_hud_root():addChild("Pane")
        self.debugTexturePane.material = "/system/DebugTexture"
        self.debugTexturePane:setUV(0,0,1,1)
        self.debugTexturePane.visible = false

        self.crosshair = get_hud_root():addChild("Pane")
        self.crosshair.material = "system/CrossHair"
        self.crosshair.resize = function (pw,ph) return pw/2-2,ph/2-2,4,4 end
...
function GFX:destroy()
        get_hud_root():removeChild(self.debugTexturePane)
